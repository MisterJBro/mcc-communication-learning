...
class Agents:
    def __init__(self, seed=0, device='cuda:0', lr_collector=1e-3, lr_guide=2e-3, gamma=0.99, max_steps=500,
        ...
        milestones = [60, 140, 900]
        self.scheduler_c = MultiStepLR(
            self.optimizer_c, milestones=milestones, gamma=0.4)
        self.scheduler_g = MultiStepLR(
            self.optimizer_g, milestones=milestones, gamma=0.4)
